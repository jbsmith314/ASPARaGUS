# Clean training
python3 brew_poison.py --poisonkey 0 --modelkey 0 --deterministic --optimization basic --only_clean_training --epochs 10                                                                     --modelsave_path models/testing      --save_epoch 9 --lr 0.01 --targets 100 --recipe patch                 --save_weights timed
python3 brew_poison.py --poisonkey 0 --modelkey 0 --deterministic --optimization basic --only_clean_training --epochs 10 --load_model models/testing/clean_model/full_epoch_9.pth     --modelsave_path models/testing  --save_epoch 19 --lr 0.01 --targets 100 --recipe patch --start_from 10 --save_weights timed
python3 brew_poison.py --poisonkey 0 --modelkey 0 --deterministic --optimization basic --only_clean_training --epochs 10 --load_model models/testing/clean_model/full_epoch_19.pth     --modelsave_path models/testing  --save_epoch 29 --lr 0.01 --targets 100 --recipe patch --start_from 20 --save_weights timed
python3 brew_poison.py --poisonkey 0 --modelkey 0 --deterministic --optimization basic --only_clean_training --epochs 10 --load_model models/testing/clean_model/full_epoch_29.pth     --modelsave_path models/testing  --save_epoch 39 --lr 0.01 --targets 100 --recipe patch --start_from 30 --save_weights timed
